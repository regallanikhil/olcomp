...
$disallowed_extensions = ['exe','js'];  // must be an array. Extensions disallowed to be uploaded
...
<style>
body {font-family: "lucida grande","Segoe UI",Arial, sans-serif; font-size: 14px;width:1024;padding:1em;margin:0;background: #f1f1f1;}
  #pagecontent{
      background: white;
    position: absolute;
    left:10%;
...
#top {height:52px;position:relative;top:5%;left: 22%;width:75%;}
...
#breadcrumb { padding-top:12px; font-size:15px; color:#aaa;display:inline-block;float:left;}
#folder_actions {width: 50%;float:right;}
a, a:visited { color:#00c; text-decoration: none}
a:hover {text-decoration: underline}
.sort_hide{ display:none;}
table {border-collapse: collapse;position:absolute;width:75%; left: 22%;top: 20%;}
...
<?php
if(!$_SESSION['access']){
include($_SERVER['DOCUMENT_ROOT'].'/usernavigation.html');
}
else include($_SERVER['DOCUMENT_ROOT'].'/verticalNavigation.html');
