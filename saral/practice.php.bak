...
include('usernavigation.html');
    ...
    <p id="Note" style="color:red">
        <form action="editorBackEnd2.php" method="POST" name="editorform" target="OutputFrame">
...
<button type="button"  onclick="document.getElementById('id01').style.display='none'" class="lcancelbtn">Cancel</button>
        ...
        <script type="text/javascript">
            ...
            function Onchange(val) {
                ...
                if (val == "java") {
                    document.getElementById('Note').innerHTML = '<b style="left:40%;">.....................................................Note:Please name your class as "main".<a href="CodeFile.java" target="OutputFrame">Refer this link</a></b>';
                }
                else {
                    document.getElementById('Note').innerHTML = "";
                }
